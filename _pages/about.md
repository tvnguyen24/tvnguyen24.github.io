...
.paper-btn {
  ...
  color: var(--global-base-color, #333) !important;
  text-decoration: none;
  cursor: pointer;
}
.paper-btn:hover { background: var(--global-thead-color, #e6e6e6); text-decoration: none; }
details.paper { display: block; }
details.paper > summary { list-style: none; }
